...
MainGame = ig.Game.extend({
  ...
  init: function() {
    ...
    ig.music.add('media/music/music.*', 'main');
    ig.music.add('media/music/boss_music.*', 'boss');
    ig.music.volume = 0.5;
    ig.music.loop = true;
    ig.music.play('main');
...
MainGame.levels = [LevelLevel1, LevelLevel2, LevelLevel3, LevelLevel4, LevelLevel5, LevelLevel6, LevelLevel7, LevelLevel8, LevelLevel9, LevelLevel10, LevelLevel11, LevelLevel12, LevelLevel13, LevelLevel14];
